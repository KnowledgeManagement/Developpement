...
<input type="submit" value="Ajouter" name="button_add_sous_menu" class="bouton" onclick="javascript:AddSousCat(document.getElementById('text_add_menu').value, <?php echo $idCat ?>);"/>
