...
<input type="submit" value="Modifier" name="button_edit_menu" class="bouton" onclick="javascript:EditCat(document.getElementById('text_edit_menu').value, <?php echo $idCat ?>);"/>
