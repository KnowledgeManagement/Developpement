...
<input type="button" value="Modifier" name="button_add_sous_menu" class="bouton" onclick="javascript:EditSousCat(document.getElementById('text_edit_sous_menu').value, <?php echo $idSousCat ?>);" />
