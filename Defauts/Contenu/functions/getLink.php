<?php
	...
	if($_SESSION['fonction'] != "Accesseur"){
		...
		$array['nomSousCatGauche'] = $cat[0]['nomSousCat'].'<a href="#" style="margin-left : 50px;" title="Ajouter une fonction" id="boutonAjout" onclick="javascript:addFunctionContributeur()">+</a>';
